...
namespace APIVerve
{
    public class RandomPunAPIClient
    {
        ...
        public RandomPunAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public RandomPunAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(randompunQueryOptions options)
        {
            try
            {
                if (_isDebug)
